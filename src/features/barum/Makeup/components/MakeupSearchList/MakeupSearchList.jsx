...
const MakeupSearchList = ({ data, selectList = [], page = 0, setPage = {}, setSelectList = {}, isLoading = true }) => {
  ...
  return (
    <section css={{ width: "100%", flex: 1, minHeight: 0, ...theme.barum.flex.colBetween }} className="MakeupSearchList">
      <div css={{ ...theme.barum.flex.rowBetween, ...theme.barum.fonts.caption, color: theme.barum.colors.ink2, marginBottom: "4px" }}>
        <span>인기순</span>
