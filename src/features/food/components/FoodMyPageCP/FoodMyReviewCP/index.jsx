...
import FoodTextAreaInputCP from "../../FoodCommon/FoodTextAreaInputCP";
      ...
      <p className="flexBetween">
        ...
        {!upDateMode && (
          <span>
            ...
            <FontAwesomeIcon icon={faTrash} style={{ cursor: "pointer", color: "var(--food-red)" }} onClick={onDeleteReview} />
          </span>
        )}
        {upDateMode && (
...
const FoodMyReviewCP = () => {
  ...
  return (
    <div css={MyReviewCPMainStyle(isPc)} isPc={isPc}>
      <h2>내 리뷰</h2>
