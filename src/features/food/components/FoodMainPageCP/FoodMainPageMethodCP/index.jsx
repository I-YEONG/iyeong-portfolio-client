...
import { foodMainPageMethodCPMainStyle, foodMainPageMethodCPStyle } from "./style";

const FoodMainPageMethodCP = () => {
  const nav = useNavigate();
  const { isPc } = useDeviceMode();

  return (
    <section css={foodMainPageMethodCPMainStyle(isPc)}>
      <div>
        <h2>이용 방법</h2>
        <p>
...
export default FoodMainPageMethodCP;
