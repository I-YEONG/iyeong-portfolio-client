...
import LoginLayout from "@/layouts/careerhi/LoginLayout";
  ...
  return (
    <LoginLayout>
      ...
      <div className="w-full max-w-105 flex flex-col justify-center gap-2">
        ...
        <p onClick={() => {}} className="B4 text-gray-500 cursor-pointer border-b w-fit">
          비밀번호를 잊어버렸습니다
        </p>
      </div>
      <div className="w-full max-w-105 mt-6 flexWidthCenter">
        ...
        <p className="w-fit text-center mt-4 B3 cursor-pointer" onClick={() => {}}>
          회원가입
        </p>
      </div>
