...
import { DomoBoxButton, DomoRecsSaveScreenshot } from "@/features/domo/components";
    ...
    <DomoMainLayout>
      <section className="flexCenter savePage">
        ...
        <div
          ...
          <DomoRecsSaveScreenshot recommendations={recommendations} ref={componentRef} />
        </div>
          ...
          <div className="isPc">
            <div>
              ...
              <div className="flexBetween">
                <div>
                  <DomoBoxButton onClickHandler={gotoHome}>홈 화면</DomoBoxButton>
                </div>
                <div className="saveButton">
                  <DomoBoxButton onClickHandler={onSaveHandler}>일정 저장</DomoBoxButton>
                </div>
              </div>
              <span className="desc">
                방금 짠 오늘 일정을
        ...
        {!isPc && (
          <div className="isMobile">
            ...
            <div>
              <DomoBoxButton onClickHandler={gotoHome}>홈화면</DomoBoxButton>
            </div>
          </div>
        )}
      </section>
