...
export const cardCss = css({
  ...
  padding: "48px 32px",
  borderRadius: "28px",
  border: `1px solid ${theme.barum.colors.surfaceMuted}`,
...
export const primaryBtnCss = css({
  ...
  fontWeight: 600,
  border: `1px solid ${theme.barum.colors.greenInk}`,
  textDecoration: "none",
...
export const ghostBtnCss = css({
  ...
  "&:hover": {
    transform: "translateY(-2px)",
    borderColor: theme.barum.colors.greenInk,
  },
});
