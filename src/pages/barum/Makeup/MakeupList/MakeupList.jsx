...
import { BarumMakeupItemList } from "@/features/barum/Makeup/components";
import { useGetMakeupList } from "@/features/barum/Makeup/hooks/useGetMakeupList";
...
import { useDeleteProduct } from "@/features/barum/Makeup/hooks/useDeleteProduct";
    ...
    <BarumHomeLayout>
      <section css={makeupPageStyle}>
        <div className="makeup">
          ...
          <div css={{ ...theme.barum.flex.rowEnd, gap: "8px" }}>
            <div onClick={() => setDeleteMode(!deleteMode)} className="delete" css={deleteStyle}>
              <FontAwesomeIcon icon={faTrash} />
            </div>
            <div className="plus" onClick={() => nav("/project/barum/makeup/create/select")}>
              + 제품 추가
            </div>
          </div>
        </div>
