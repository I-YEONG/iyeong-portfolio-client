...
export const layoutStyle = css({
  overflow: "hidden",
  "& header": { justifyContent: "start", gap: "18px", ...theme.barum.fonts.section, marginBottom: "16px" },
});
...
export const makeupCameraResultStyle = css({
  ...
  "& .top-box": {
    ...
    "& .img-box": {
      ...
      -45deg,
      ${theme.barum.colors.green},
      ${theme.barum.colors.green} 8px,
      ${theme.barum.colors.veil} 8px,
      ${theme.barum.colors.veil} 16px
    )`,
    },
  ...
  "& .list": {
    ...
    "& .box": {
      ...
      "& > div": {
        ...
        "&:not(:last-of-type)": {
          borderBottom: `1px solid ${theme.barum.colors.surfaceMuted}`,
        },
        "& .name": {
