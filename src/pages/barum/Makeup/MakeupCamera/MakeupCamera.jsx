...
import { BarumLeftButton, BarumBarButton } from "@/components/barum";
import { BarumBasicLayout } from "@/layouts";
import { BarumMakeupCameraView } from "@/features/barum/Makeup/components";
import { useMakeupOcrUpload } from "@/features/barum/Makeup/hooks/useMakeupOcrUpload";
...
import {
  ...
  loaderWrapperStyle,
  routineItem,
} from "@/pages/barum/Routine/RoutineLoading/RoutineLoading.style";
    ...
    uploadAndRecognize(
      { file, alias },
      {
        onSuccess: (result) => {
          ...
          nav("/project/barum/makeup/create/camera/result", { state: { ocrResult: result } });
        },
        onError: (error) => {
          setIsUploading(false);
          setLoadingProgress(18);
          ...
          if (error?.code === "OCR_NO_TEXT") {
            nav("/project/barum/makeup/create/error?type=OCR_NO_TEXT");
            return;
          }
  ...
  return (
    <BarumBasicLayout styleObj={layoutStyle}>
        ...
        {!isUploading && (
          <>
            ...
            <section className="camera">
              ...
              <BarumMakeupCameraView captureRef={cameraCaptureRef} />
            </section>
      ...
      <nav css={shootButton}>
        ...
        {isUploading && <BarumBarButton colorTheme="none">인식 중...</BarumBarButton>}
      </nav>
    </BarumBasicLayout>
  );
};
