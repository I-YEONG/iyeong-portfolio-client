...
export const loaderWaveStyle = css({
  ...
  inset: 0,
  borderRadius: "50%",
  background: theme.barum.colors.greenSoft,
...
export const loaderOrbitStyle = css({
  ...
  "& > i": {
    ...
    height: "8px",
    borderRadius: "50%",
    background: theme.barum.colors.greenDot,
  },
});
...
export const loaderOrbitSlowStyle = css([
  loaderOrbitStyle,
  {
    ...
    "& > i": {
      ...
      width: "6px",
      height: "6px",
      background: theme.barum.colors.blueInk3,
      opacity: 0.55,
    },
  },
]);
...
export const loaderCoreStyle = css({
  ...
  height: "132px",
  borderRadius: "50%",
  background: theme.barum.colors.green,
  color: theme.barum.colors.onGreen,
  boxShadow: theme.barum.shadow.boxShadow,
  ...theme.barum.flex.center,
