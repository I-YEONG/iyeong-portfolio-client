...
import { foodRegisterPageMainStyle, foodRegisterPageMenuStyle, foodRegisterPageScheduleStyle } from "./style";
import { FoodButtonCP, FoodInputCP, FoodOutLineButtonCP, FoodSelectInputCP, FoodTextAreaInputCP } from "@/features/food/components";
...
const FoodRegisterPage = () => {
  ...
  //FIXME: OR "ADMIN" OR "USER"
  const isRole = "president";
   ...
   * @returns {void}
   * - 입력값 유효성 검사 후, 문제가 없으면 등록 성공 처리 (API 제외)
   * - 성공 시 안내 후 입력값 초기화 및 페이지 이동
   */
  ...
  const handleChange = (e) => {
    ...
    console.log("FoodRegisterPage - 선택된 파일:", selectedFile);
    if (selectedFile) {
      console.log("FoodRegisterPage - 파일명:", selectedFile.name);
      console.log("FoodRegisterPage - 파일 크기:", selectedFile.size);
      console.log("FoodRegisterPage - 파일 타입:", selectedFile.type);
    }
  ...
  return (
    <FoodMainLayOut>
      <main css={foodRegisterPageMainStyle(isPc)}>
        <section>
          <div>
            <h1>푸드트럭 정보 등록</h1>
          ...
          <div>
            ...
            <div className="col">
              ...
              <div>
                <FoodSelectInputCP title="카테고리" essential="true" listData={FTCategoryList} onChangeHandler={onChangeFTCategory} />
          ...
          {/* 메뉴 정보 */}
          <div css={foodRegisterPageMenuStyle(isPc)}>
            <h2>메뉴 정보</h2>
            <div className="col">
                  ...
                  {menuList
                    ...
                    .map((menu, idx) => (
                      <div key={idx} className="menu-item">
                        ...
                        {menu?.info?.length > 0 && <p className="menu-item-info">{menu.info}</p>}
                      </div>
                    ))}
                </div>
          ...
          {/* 운영 정보 */}
          <div css={foodRegisterPageScheduleStyle(isPc)}>
            <h2>
          ...
          <div>
            <h2>사업자 정보</h2>
            <div className="col-full">
              <FoodInputCP title="사업자 등록번호" essential="true" ex="000-00-00000" />
          ...
          <div className="col-full">
            <div className="axiosButton" onClick={registerSubmitHandler}>
              <FoodButtonCP>등록 신청</FoodButtonCP>
            </div>
          </div>
        </section>
